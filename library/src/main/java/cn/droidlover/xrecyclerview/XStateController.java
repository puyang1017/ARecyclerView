...
public class XStateController extends FrameLayout {
    ...
    XStateController.OnStateChangeListener stateChangeListener;
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        XStateController.SavedState savedState = new XStateController.SavedState(parcelable);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        XStateController.SavedState savedState = (XStateController.SavedState) state;
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Creator<XStateController.SavedState> CREATOR =
                new Creator<XStateController.SavedState>() {
                    @Override
    ...
    public void registerStateChangeListener(XStateController.OnStateChangeListener stateChangeListener) {
        this.stateChangeListener = stateChangeListener;
    }

    public XStateController.OnStateChangeListener getStateChangeListener() {
    ...
    private XStateController.OnStateChangeListener getDefaultStateChangeListener() {
        return new XStateController.SimpleStateChangeListener();
    }
    ...
    public static class SimpleStateChangeListener implements XStateController.OnStateChangeListener {
